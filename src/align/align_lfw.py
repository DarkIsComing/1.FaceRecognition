    ...
    with open(output_filename, "w") as text_file:
        ...
        for fimage in dataset:
            ...
            try:
                ...
                _paths = fimage.image_path.replace('\\','/').split('/')
...
def parse_arguments(argv):
    ...
    parser.add_argument('--input-dir', default='D:/03.work/02.development/04.PaidOn/1.FaceRecognition/2.Dataset/2.PaidOnData/1.TrainData/CASIA-FaceV5/00000010',type=str, help='Directory with unaligned images.')
    parser.add_argument('--output-dir',default='D:/03.work/02.development/04.PaidOn/1.FaceRecognition/2.Dataset/2.PaidOnData/1.TrainData/CASIA-FaceV5/test',type=str, help='Directory with aligned face thumbnails.')
