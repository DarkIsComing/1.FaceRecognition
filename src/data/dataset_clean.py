...
if __name__ == '__main__':
  ...
  # general
  parser.add_argument('--input', default='D:/03.work/02.development/04.PaidOn/1.FaceRecognition/2.Dataset/1.OfficialData/1.traindata/faces_umd', type=str, help='')
  parser.add_argument('--output', default='D:/03.work/02.development/04.PaidOn/1.FaceRecognition/2.Dataset/1.OfficialData/1.traindata/faces_umd_clean', type=str, help='')
