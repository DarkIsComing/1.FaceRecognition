...
def parse_args():
    ...
    parser.add_argument('--prefix', default='F:/5.dataset_divi/_train',help='prefix of input/output lst and rec files.')
    parser.add_argument('--root',default='F:/5.dataset_divi/_train', help='path to folder containing images.')

    cgroup = parser.add_argument_group('Options for creating image lists')
    cgroup.add_argument('--list', action='store_false',
