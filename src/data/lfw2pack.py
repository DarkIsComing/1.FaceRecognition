...
# general
parser.add_argument('--data-dir', default='F:/5.dataset_divi/pack1/_test', help='')
parser.add_argument('--image-size', type=str, default='112,112', help='')
parser.add_argument('--output', default='F:/5.dataset_divi/pack1/_test/shunde', help='path to save.')
